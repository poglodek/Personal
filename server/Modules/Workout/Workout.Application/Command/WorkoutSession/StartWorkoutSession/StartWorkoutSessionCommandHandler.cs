...
public class StartWorkoutSessionCommandHandler : IRequestHandler<StartWorkoutSessionCommand>
{
    ...
    public async Task Handle(StartWorkoutSessionCommand request, CancellationToken cancellationToken)
    {
